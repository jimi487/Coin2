package com.bohil.coin.ui.adapter;
...
public class ToStringArrayAdapter<T> extends ArrayAdapter<T> {
    ...
    private final com.bohil.coin.ui.adapter.ToString<T> mToString;
    ...
    public ToStringArrayAdapter(final Context context,
                                ...
                                final com.bohil.coin.ui.adapter.ToString<T> toString,
                                final T[] items) {
    ...
    private View baseGetView(final int itemIndex, final @Nullable View itemView, final @NonNull ViewGroup parentView) {
        ...
        final com.bohil.coin.ui.adapter.ToStringViewHolder viewHolder = itemView == null
                ? createViewHolder(parentView)
                : (com.bohil.coin.ui.adapter.ToStringViewHolder) itemView.getTag();

        viewHolder.setText(getContext(), itemIndex, item);
        return viewHolder.getView();
    }

    private com.bohil.coin.ui.adapter.ToStringViewHolder createViewHolder(final ViewGroup parentView) {
        final LayoutInflater layoutInflater = LayoutInflater.from(getContext());
        final View view = layoutInflater.inflate(mItemLayoutId, parentView, false);

        final com.bohil.coin.ui.adapter.ToStringViewHolder viewHolder = new com.bohil.coin.ui.adapter.ToStringViewHolder<T>(mToString, view, mTextViewId);
